...
public:
    bool open(int in_channels, int in_samples, int in_sample_size, int out_channels, int out_samples, int out_sample_size, int frames)
    {
        ...
        switch (in_channels) {
        case 1:
            av_channel_layout_default(&src_ch_layout, 1);
            break;
        case 2:
        ...
        switch (out_channels) {
        case 1:
            av_channel_layout_default(&dst_ch_layout, 1);
            break;
        case 2:
        ...
        max_dst_nb_samples = dst_nb_samples = av_rescale_rnd(src_nb_samples, dst_samples_, src_samples_, AV_ROUND_UP);
        ...
        dst_nb_samples = av_rescale_rnd(swr_get_delay(swr_ctx, src_samples_) + src_nb_samples,
            dst_samples_, src_samples_, AV_ROUND_UP);
...
private:
    ...
    AVChannelLayout src_ch_layout = { 0 }, dst_ch_layout = { 0 };
